...
const ENEMY_DEFS = {
  ...
  veinWarden: { art: '卫', name: '矿脉守卫', description: '守着主矿脉的重甲单位，装甲板就是从它身上撬下来的标准件。', maxHp: 160, attack: 16, defense: 8, attackInterval: 2.2, gold: 95, dropTable: [{ itemId: ITEM.armorPlate, chance: .6, min: 1, max: 2 }, { itemId: ITEM.scrap, chance: 1, min: 8, max: 12 }, { itemId: ITEM.emberCore, chance: .04, min: 1, max: 1 }] },
  ...
  moltenHound: { art: '渣', name: '熔渣猎犬', description: '关节处凝着熔渣的追猎单位，越打越烫。', maxHp: 155, attack: 15, defense: 5, attackInterval: 1.6, gold: 70, dropTable: [{ itemId: ITEM.scrap, chance: 1, min: 6, max: 10 }, { itemId: ITEM.emberCore, chance: .04, min: 1, max: 1 }] },
  ...
  coreDrone: { art: '机', name: '核心无人机', description: '围绕井口盘旋的维护机，炮口对准一切还在动的东西。', maxHp: 300, attack: 8, defense: 12, attackInterval: 1.4, gold: 80, dropTable: [{ itemId: ITEM.scrap, chance: 1, min: 10, max: 16 }, { itemId: ITEM.emberCore, chance: .05, min: 1, max: 1 }, { itemId: ITEM.logisticsManual, chance: .05, min: 1, max: 1 }] },
  ...
  echoWraith: { art: '影', name: '回声残影', description: '一段没能散掉的旧信号，出手快得只留下一道残影。', maxHp: 350, attack: 14, defense: 10, attackInterval: 2.8, gold: 90, dropTable: [{ itemId: ITEM.emberCore, chance: .05, min: 1, max: 1 }, { itemId: ITEM.emberShard, chance: .4, min: 1, max: 2 }] },
  abyssBrute: { art: '渊', name: '深渊重装者', description: '井底的重载单位，每一块装甲都比远征队整支队伍还厚。', maxHp: 410, attack: 8, defense: 18, attackInterval: 2, gold: 145, dropTable: [{ itemId: ITEM.armorPlate, chance: 1, min: 2, max: 3 }, { itemId: ITEM.scrap, chance: 1, min: 12, max: 18 }, { itemId: ITEM.emberCore, chance: .06, min: 1, max: 1 }] },
  coreTitan: { art: '枢', name: '核心泰坦', description: '井底那颗仍在搏动的核心本身。所有信号的源头。', maxHp: 480, attack: 13, defense: 18, attackInterval: 3.2, gold: 160, dropTable: [{ itemId: ITEM.emberCore, chance: .12, min: 1, max: 1 }, { itemId: ITEM.armorPlate, chance: 1, min: 3, max: 4 }, { itemId: ITEM.emberShard, chance: .8, min: 2, max: 3 }] },
  ...
  magmaSentry: { art: '哨', name: '岩浆哨卫', description: '立在裂口两侧的旧时代哨戒塔，炮管被地热烫得发亮。', maxHp: 515, attack: 22, defense: 14, attackInterval: 2, gold: 160, dropTable: [{ itemId: ITEM.scrap, chance: 1, min: 14, max: 20 }, { itemId: ITEM.emberCore, chance: .06, min: 1, max: 1 }] },
  cinderWraith: { art: '影', name: '灰烬幽影', description: '一团不肯散去的热浪，靠近时连呼吸都在发烫。', maxHp: 515, attack: 25, defense: 10, attackInterval: 2.4, gold: 145, dropTable: [{ itemId: ITEM.emberShard, chance: .7, min: 2, max: 4 }, { itemId: ITEM.emberCore, chance: .05, min: 1, max: 1 }] },
  ...
  riftColossus: { art: '像', name: '裂谷巨像', description: '从裂谷壁上整片剥下来又自己站起来的岩层，走一步震一下。', maxHp: 585, attack: 25, defense: 18, attackInterval: 3, gold: 200, dropTable: [{ itemId: ITEM.emberCore, chance: .1, min: 1, max: 1 }, { itemId: ITEM.armorPlate, chance: 1, min: 2, max: 3 }, { itemId: ITEM.emberShard, chance: .7, min: 2, max: 3 }] }
